 ...
 */
final class Version20230528131715 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE property CHANGE post post VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE property CHANGE post post VARCHAR(11) NOT NULL');
    }
}
